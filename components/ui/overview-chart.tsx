  ...
  const formatDate = (dateString: string) => {
    try {
      ...
      const daysDiff = differenceInDays(
        parseISO(completeData[completeData.length - 1]?.date || dateString),
        parseISO(completeData[0]?.date || dateString)
      );
      ...
      <CardContent>
        {data.length === 0 ? (
          ...
          <div className="relative">
            {!hasNonZeroData && (
              <div className="bg-background/80 absolute inset-0 z-10 flex items-center justify-center rounded">
                <div className="text-muted-foreground text-center">
                  <div className="mb-1 text-lg">0</div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Bar
                    ...
                    radius={[4, 4, 0, 0]}
                    maxBarSize={
                      completeData.length <= 7
                        ? 80
                        : completeData.length <= 15
                          ? 60
                          : 40
                    }
                  />
